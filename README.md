Fork of [waitingsong/node-win32-api](https://github.com/waitingsong/node-win32-api). The list of changes is available in the [module-level README](./packages/win32-api/README.md).
